...
// 
//     } else {
// //         r=HarmonicGradPhys(springlist,XY,g11,g12,g22)+BendingGrad(springpairs,springlist,XY,kappa,g11,g12,g22);
//            r=HarmonicGradPhys(springlist,XY,sheardeformation)+bendinggradnew(XY,springlist,springpairs,kappa,sheardeformation);
// 
//     }
// 
//     s=r;
...
//         if(bendingon==0){
//             XYn=XY+sigma0*d;
//             etaprev=(HarmonicGradPhys(springlist,XYn,sheardeformation)).dot(d);
//         } else{
// 
//             etaprev=(HarmonicGradPhys(springlist,XYn,sheardeformation)+
//              bendinggradnew(XYn,springlist,springpairs,kappa,sheardeformation)).dot(d);
//         }
//         
//         do{
//             if(bendingon==0){
...
//              } else{
//                 eta=(HarmonicGradPhys(springlist,XY,sheardeformation)+
//                 bendinggradnew(XY,springlist,springpairs,kappa,sheardeformation)).dot(d);
//             }
//             double dsq=d.dot(d);
//             deta=etaprev-eta;
//             if(fabs(deta)>1e-22){
...
//         if(bendingon==0){
//             r=-HarmonicGradPhys(springlist,XYn,sheardeformation);
//         } else{
//             r=-(HarmonicGradPhys(springlist,XYn,sheardeformation)+
//             bendinggradnew(XYn,springlist,springpairs,kappa,sheardeformation));
//         }
//         deltaold=deltanew;
//         deltamid=r.dot(s);
//         
...
// int cg_method(VectorXd &XY,vector<spring> &springlist,vector<vector<int > > &springpairs,double kappa,double sheardeformation)
// {
//     int i=0;
//     int imax=100;
//     double eps=1e-6;
//     int k=0;
//     VectorXd r=-HarmonicGradPhys(springlist,XY,sheardeformation)-bendinggradnew(XY,springlist,springpairs,kappa,sheardeformation);    ;
//     VectorXd d=r;
